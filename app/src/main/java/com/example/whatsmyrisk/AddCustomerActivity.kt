...
class AddCustomerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<TextView>(R.id.aap_heading).setText("Add Customer")
        ...
        findViewById<TextView>(R.id.btn_download_Template).setOnClickListener() {
            val url =
                "https://laravel.cppatidar.com/whatsmyrisk/public/exceldownload/file_example_XLS_10.xls"
        ...
        findViewById<TextView>(R.id.btn_next_customer).setOnClickListener() {
            ...
            intent.putExtra("AppTile", " Customer")
            startActivity(intent)
        }

        findViewById<TextView>(R.id.btn_upload_certificate).setOnClickListener(View.OnClickListener {
...
//                    val reqFile = file.asRequestBody("application/octet-stream".toMediaTypeOrNull())
    ...
    private fun uploadCustomer(newUri: String) {
        ...
        if (newUri?.isNotEmpty()!!) {
            ...
            val types: RequestBody = Constants.createPartFromString("0")
                ...
                .enqueue(
                    object : retrofit2.Callback<StatusMessage> {
                        override fun onResponse(call: Call<StatusMessage>, response: Response<StatusMessage>) {
                            ...
                            {
                                Toast.makeText(this@AddCustomerActivity, "" + response.body()!!.message, Toast.LENGTH_LONG).show()
                                val intent = Intent(this@AddCustomerActivity,DashboardActivity ::class.java)
                                startActivity(intent)
                                finish()
                            }
                            else
                            {
                                Toast.makeText(this@AddCustomerActivity, "Please try again", Toast.LENGTH_SHORT).show()
                            }
                        }
