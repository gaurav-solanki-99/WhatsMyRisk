...
class UpdateFeedBackActivity : AppCompatActivity() {
    var dialog: Dialog? = null


    var all_country_name_list: java.util.ArrayList<String> = ArrayList()
    var all_country_id_list: java.util.ArrayList<String> = ArrayList()
...
//    lateinit var spinner_buisness_sub__category : Spinner
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.update_feed_back_form)
        supportActionBar?.hide()
        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_HIDDEN);

        btnUpdate=findViewById<TextView>(R.id.btn_update_customer)
...
//        spinner_buisness_sub__category = findViewById<Spinner>(R.id.spinner_buisness_subCategory)
        ...
        Log.e("Selected_sutomer",""+customerlist[index!!].name)
        ...
        setAllfields(customerlist[index])
        findViewById<TextView>(R.id.search_paymaster2).text= resources.getStringArray(R.array.Paymaster)[customerlist[index].paymaster!!.toInt()]
        findViewById<TextView>(R.id.search_rating2).text= customerlist[index].rating.toString()
        business_category=customerlist[index].businessCategoryId!!.toInt();
        business_type=customerlist[index].businessTypeId!!.toInt();
        country=customerlist[index].countryId!!.toInt();
        state=customerlist[index].stateId!!.toInt();
        city=customerlist[index].cityId!!.toInt();
        rating=customerlist[index].rating!!.toInt();
        paymaster=customerlist[index].paymaster!!.toInt();
        ...
        btnUpdate.setOnClickListener()
        {
            if (validate())
            {
                ...
                GetRetrofitInstance.instance.UpdateCustomerFeedbackApi(PrefManager.getString(this, PrefManager.TOKEN_TYPE) + " " + PrefManager.getString(this, PrefManager.ACCESS_TOKEN),
                        name,
                        business_name,
                        business_category,
                    ...
                    override fun onResponse(call: Call<StatusMessage>, response: Response<StatusMessage>) {
                        ...
                        if (response.body()!!.status == true) {
                            Toast.makeText(this@UpdateFeedBackActivity, "" + response.body()!!.message, Toast.LENGTH_SHORT).show()


                            var intent: Intent = Intent(this@UpdateFeedBackActivity, DashboardActivity::class.java)
...
//                findViewById<TextView>(R.id.search_spinner_country)!!.setText(countryAllList[cu])
              ...
              //  all_country_name_list.add("Select Country")
              //  all_country_id_list.add("0")
                for (i in 0 until response.body()!!.data!!.size) {
                    all_country_name_list.add(response.body()!!.data!![i].name!!)
                    all_country_id_list.add(response.body()!!.data!![i].id!!.toString())

                }

              var selectedValue =   all_country_name_list[all_country_id_list.indexOf(customers.countryId.toString()).toInt()]
                findViewById<TextView>(R.id.search_spinner_country)!!.setText(selectedValue)


                Log.e("Selected Counrty ",">>>>>>>>>>>>>>>> $selectedValue "+customers.countryId)
                ...
                Log.e("All Country List ", all_country_name_list.toString())
                ...
                spinner_countyr.onItemSelectedListener =
                    object : AdapterView.OnItemSelectedListener {
                        override fun onItemSelected(
                            ...
                            country = all_country_id_list.get(position).toInt()
                ...
                findViewById<View>(R.id.search_spinner_country)!!.setOnClickListener(View.OnClickListener {
                    // Initialize dialog
                    dialog = Dialog(this@UpdateFeedBackActivity)
                    ...
                    listView.onItemClickListener =
                            AdapterView.OnItemClickListener { parent, view, position, id -> // when item selected from list
                                ...
                                val selectedIndex = all_country_name_list.indexOf(item)

                                country = all_country_id_list[selectedIndex].toInt()
                                getAllStateList(country,customers,false)
        ...
        GetRetrofitInstance.instance.stateApi(tokentype + " " + token, country_id).enqueue(object :
            ...
            override fun onResponse(call: Call<CountryList>, response: Response<CountryList>) {
              ...
              //  state_id_list.add("0")
                ...
                Log.e("All State List ", state_name_list.toString())
                }
                ...
                // Toast.makeText(this@UpdateFeedBackActivity, "All Country List" + countryAllList.size.toString(), Toast.LENGTH_LONG).show()


            }

            override fun onFailure(call: Call<CountryList>, t: Throwable) {
                // Toast.makeText(this@UpdateFeedBackActivity, "CountryList error please try again...", Toast.LENGTH_SHORT).show()
            }
            ...
            override fun onResponse(call: Call<CountryList>, response: Response<CountryList>) {
              ...
              //  city_name_list.add("Select City")
               // city_id_list.add("0")
                ...
                if(isSelected)
                {
                    Log.e("Selected City", customers.cityId.toString())
                ...
                // Toast.makeText(this@UpdateFeedBackActivity, "All getAllCityList List" + countryAllList.size.toString(), Toast.LENGTH_LONG).show()
        ...
        GetRetrofitInstance.instance.categoryApi(tokentype + " " + token).enqueue(object :
            ...
            override fun onResponse(call: Call<CountryList>, response: Response<CountryList>) {
               ...
               /// country_id_list.add("0")
                ...
                val adapter1 = ArrayAdapter(this@UpdateFeedBackActivity, android.R.layout.simple_dropdown_item_1line, country_name_list)
